...
/**
 * Registers Giscus if there's an #redot-giscus container.
 * @returns {void} Nothing.
 */
const registerGiscus = function () {
  const giscusContainer = document.getElementById("redot-giscus");
  ...
  const dataset = {
    repo: "redot-engine/redot-docs-user-notes",
    repoId: "R_kgDOKuNx0w",
...
$(document).ready(() => {
  ...
  // See `redot_is_latest` in conf.py
  ...
  if (isLatest) {
    ...
    const homeUrl = 'https://docs-stable.redotengine.org/';
